...
```{r}
 ggplot(data = Liberia_datos.climaticos, aes(x = Temperatura..Celsius.)) + geom_histogram(binwidth = 2,
 color = "red",
 fill = "white") +
  facet_grid()
```
...
```{r}
ggplot(data = Liberia_datos.climaticos, aes(x = HumedadRelativa....,)) + geom_histogram(binwidth = 2, 
color = "green",                
fill= "white") +
  facet_grid()
...
```{r}
ggplot(data = Liberia_datos.climaticos, aes(x = VelocidadViento..m.s.))+ geom_histogram(binwidth = 2,
 color = "purple",
 fill = "white") +
  facet_grid()
```
...
```{r}
ggplot(data = Liberia_datos.climaticos, aes(x = Lluvia..mm.))+ geom_histogram(binwidth = 2,
 color = "blue",
 fill = "white") +
  facet_grid()
```
...
```{r}
ggplot(data = Liberia_datos.climaticos, aes(x = Irradiacion..W.m2.))+ geom_histogram(binwidth = 2,
 color = "orange",
 fill = "white") +
  facet_grid()
```
...
```{r}
 ggplot(data = Liberia_datos.climaticos, aes(x = EvapoTranspiracion..mm.))+ geom_histogram(binwidth = 2,
 color = "pink",
 fill = "grey") +
  facet_grid()
```
